...
if (Posts.find().count() === 0) {
  ...
  post = {
     ...
     bodyMessage: 'This is request for test4',
     submitted: new Date(now - 12 * 3600 * 1000),
     commentsCount: 0,
     precatis: [userId1, userId3, userId3],
     prayedCount: 3,
  ...
  posts = {
    ...
    userId: user3._id,
    author: user3.profile.name,
    bodyMessage: 'This a request without a tag',
    submitted: new Date(now - 12 * 3600 * 1000),
    commentsCount: 0,
    precatis: [],
    prayedCount: 0,
